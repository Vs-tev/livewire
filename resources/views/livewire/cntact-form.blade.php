<div>
    <!-- component -->
    <form wire:submit.prevent="submitForm" action="/contacts" method="POST" class="grid grid-cols-1 row-gap-6">
        @csrf
        ...
        <div class="p-4">
            ...
            <div class="relative p-5 border-gray-500 rounded-md shadow-sm">
                <input wire:model="name" id="name" class="" name="name" value="{{ old('name') }}"
